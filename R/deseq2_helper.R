...
makeFeatureData <- function(gene_id2gene_name, mat){

                ens2gene <- read.csv(gene_id2gene_name, header=TRUE, stringsAsFactors=FALSE, sep="\t")
		rownames(ens2gene) <- as.character(ens2gene$gene_id)
		ens <- rownames(mat)
