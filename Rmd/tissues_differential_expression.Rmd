...
p1 <- plotPrincipleComponents(pc, metadata, colourby="Tissue.location", shapeby="Disease", group="Individual", pcs=c("PC1", "PC2"))
...
dds <- DESeqDataSetFromMatrix(countData = mat,
                              colData = metadata,
                  	      design = ~ Individual + Tissue.location)
...
genesets.tf <- read.csv("annotations/c3.tft.v6.1.symbols.tsv", header=FALSE, sep="\t")
