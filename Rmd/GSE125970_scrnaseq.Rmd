...
```{r load.libraries.scrnaseq, message=FALSE, echo=FALSE}
...
```{r total.ggt1.pos, echo=FALSE, message=FALSE, fig.height=5, fi.width=5}
...
```{r top10.in.ggt1pos, echo=FALSE, message=FALSE, fig.height=5, fig.width=15}
...
pathway.results$goid <- factor(pathway.results$goid, levels=pathway.results$goid)
...
```{r session.info.scrnaseq, echo=FALSE, message=FALSE}
